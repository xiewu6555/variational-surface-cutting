...
class UnitVector3 : public Vector3 {
   public:
      ...
      const UnitVector3& operator=(const Vector3& v) { x = v.x; y = v.y; z = v.z; normalize(); return *this; }
      const UnitVector3& operator=(const UnitVector3& u) { x = u.x; y = u.y; z = u.z; return *this; }
};
